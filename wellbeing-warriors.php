    ...
    <div class='outer-container'>
        <div class='course-screen'>
            ...
            <div class='session-bar'>
                ...
                <div id='div_session_1'>Session 1</div>
                <div id='div_session_2'>Session 2</div>
                <div id='div_session_3'>Session 3</div>
                <div id='div_session_4'>Session 4</div>
                <div id='div_session_5'>Session 5</div>
            </div>
            <!-- Header -->
...
function quiz_slide($course_id, $slide_num){
    ...
    <div class='button-bar'>
        ...
        <button class='session-color-button' onclick='notesButton()'>Notes</button>
        <button class='session-color-button' id='btn_show' onclick='showAnswer()'>Reveal Answer</button>
    ";
